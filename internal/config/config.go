...
func Load() Config {
	...
	txnAsyncWorkersInit, _ := strconv.Atoi(getenvCompat("TXN_ASYNC_WORKERS_INIT", "TXN_ASYNC_STAGE_WORKERS_INIT", "4"))
	txnAsyncWorkersPaySuccess, _ := strconv.Atoi(getenvCompat("TXN_ASYNC_WORKERS_PAY_SUCCESS", "TXN_ASYNC_STAGE_WORKERS_PAY_SUCCESS", "4"))
